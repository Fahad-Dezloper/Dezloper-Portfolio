  ...
  return (
    <div className="max-w-2xl">
      <div className="flex flex-col gap-4">
        ...
        <span>
          I care deeply about the interface — that’s my{" "}
          <Link href="/craft" className="underline">
            craft
          </Link>
          , that’s where I shine.
        </span>
        <span>
          I’ve worked across different layers of the stack: Shopify CMS, trading
          algorithms in Rust, authentication systems, Web3 key management, and
          real-time workflows. I’ve built trading terminals, mobile apps, and
          full-stack web applications.
        </span>{" "}
        <span>
          Right now, I’m focused on becoming a great design engineer and
          building fast, thoughtful products with AI's as my co-founder.
        </span>
      </div>
